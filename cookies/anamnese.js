...
function anamneseCookie() {
    ...
    */
    ...
    let snSentada = document.getElementById('snSentada').value; //snSentada = Costuma permanecer muito tempo sentada ? valor para sim = s, para nao = n.
    let aCirurgicos = document.getElementById('aCirurgicos').value;// igual o valor de Antecedentes Cirurgicos? valor para sim = s, para nao = n
    let tEstetico = document.getElementById('tEstetico').value;  // igual o valor de Tratamentos Esteticos Anteriores? valor para sim = s, para nao = n
    let aAlergicos = document.getElementById('aAlergicos').value;// igual o valor de Antecedentes Alergicos? valor para sim = s, para nao = n
    let fIntestinal = document.getElementById('fIntestinal').value;// igual o valor de Funcionamento intestinal regular? valor para sim = s, para nao = n
    let fumante = document.getElementById('fumante').value;// igual o valor de é fumante? valor para sim = s, para nao = n
    let alimentacaoBalanceada = document.getElementById('alimentacaoBalanceada').value;// igual o valor de  alimentaçao Balanceada? valor para sim = s, para nao = n
    let praticaAF = document.getElementById('praticaAF').value;// igual o valor de pratica Atividade Fisica ? valor para sim = s, para nao = n
    let ingereL = document.getElementById('ingereL').value;// igual o valor de Ingere líquidos com frequência? valor para sim = s, para nao = n
    let gestante = document.getElementById('gestante').value;// igual o valor de É gestante? valor para sim = s, para nao = n
    let pOrtopedico = document.getElementById('pOrtopedico').value;// igual o valor de Tem algum problema ortopédico? valor para sim = s, para nao = n
    let tMedico = document.getElementById('tMedico').value;// igual o valor de Faz algum tratamento médico? valor para sim = s, para nao = n
    let acidos_pele = document.getElementById('acidos_pele').value;// igual o valor de Usa ou já usou ácidos na pele? valor para sim = s, para nao = n
    let tOrtomoleculars = document.getElementById('tOrtomolecular').value;// igual o valor de Já fez algum tratamento ortomelecular ? valor para sim = s, para nao = n
    let marcapasso = document.getElementById('marcapasso').value;// igual o valor de A È portador de marcapasso? valor para sim = s, para nao = n
    let metais = document.getElementById('metais').value;// igual o valor de Presença de metais? valor para sim = s, para nao = n
    let oncologicos = document.getElementById('oncologicos').value;// igual o valor de Antecedentes oncológicos? valor para sim = s, para nao = n
    let menstrual = document.getElementById('menstrual').value;// igual o valor de Ciclo menstrual regular? valor para sim = s, para nao = n
    let anticoncepsional = document.getElementById('anticoncepsional').value;// igual o valor de Usa método anticoncepcional? valor para sim = s, para nao = n
    let varizes = document.getElementById('varizes').value;// igual o valor de Varizes? valor para sim = s, para nao = n
    let lesoes = document.getElementById('lesoes').value;// igual o valor de Lesões ? valor para sim = s, para nao = n
    let hipertensao = document.getElementById('hipertensao').value;// igual o valor de Hipertensão? valor para sim = s, para nao = n
    let epilepsia = document.getElementById('epilepsia').value;// igual o valor de Epilepsia? valor para sim = s, para nao = n
